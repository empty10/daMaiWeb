const CONFIG = require('./config'),
    ...
    PROJECTS_PATH = './json/project.json',
    FIELD_PATH = './json/field.json',
...
app.use(async (req, res, next) => {
    ...
    req.projectsDATA = JSON.parse(await readFile(PROJECTS_PATH));
    req.fieldDATA = JSON.parse(await readFile(FIELD_PATH));
    req.orderDATA = JSON.parse(await readFile(ORDER_PATH));
    req.favoriteDATA = JSON.parse(await readFile(FAVORITE_PATH));
    next();
});
