...
let dataFooter = [{id: 86, title: '+86中国大陆地区'}, {id: 852, title: '+852中国香港地区'}, {
    id: 853,
    title: '+853中国澳门地区'
}, {id: 886, title: '+886中国台湾地区'}];
    ...
    render() {
        ...
        return <div>
            ...
            <div className='personLoginBox'>
                ...
                }><Icon type='down'></Icon></span><input type="text" placeholder='请输入手机号码' className='phonePass'/></div>*/}
                </div>
                <Form onSubmit={this.handleSubmit} className="login-form" style={{margin: '.2rem'}}>
                    ...
                    <FormItem>
                        <Button type="danger" htmlType="submit" className="login-form-button"
                                style={{width: '3.75rem'}}>登录</Button>
                        <Link to='/personal/person' style={{width: '3.75rem', 'margin-right': '.1rem'}}><Button
                            type='danger' style={{width: '3.75rem', 'margin-top': '.2rem'}}>注册</Button></Link>
                    </FormItem>
                </Form>
            </div>
        </div>
